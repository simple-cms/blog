          ...
          <ul class="nav nav-tabs pull-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                @if (isset($post))
                <li role="presentation"><a href="{{ route(config('post.postURL') .'.show', [$post->slug]) }}" target="_blank" role="menuitem" tabindex="-1" href="#"><i class="fa fa-eye"></i> {{ Lang::get('core::core.preview')}}</a></li>
                @endif
